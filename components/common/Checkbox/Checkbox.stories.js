...
export const withTextLeft = () => ({
    ...
    template:
        '<Checkbox v-model=\'checked\' position="left">Со значком слева</Checkbox>',
});
...
export const withTextRight = () => ({
    ...
    template:
        '<Checkbox v-model=\'checked\' position="right">Со значком справа</Checkbox>',
});
...
export const primary = () => ({
    ...
    template:
        "<Checkbox v-model='checked' type='primary'>Акцентный при нажатии</Checkbox>",
});
...
export const rounded = () => ({
    ...
    template:
        "<Checkbox v-model='checked' :rounded=\"true\" type='primary'>Скругленный</Checkbox>",
});
...
export const disabled = () => ({
    ...
    template:
        '<Checkbox v-model=\'checked\' :disabled="true">Не интерактивный</Checkbox>',
});
