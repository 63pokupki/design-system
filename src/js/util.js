...
const stock_dropdown_filter = document.querySelectorAll(
...
if (stock_dropdown_filter) {
    stock_dropdown_filter.forEach((filter) => {
        ...
        heading.addEventListener('click', () =>
            filter.classList.toggle('is-expanded')
        );
    });
}

const item_params_list__items = document.querySelectorAll(
        ...
        auth_wrap.forEach((aw) => {
            ...
            auth_tabs.addEventListener('click', () => {
                if (auth_tabs.checked === true) {
                    ...
                    aw.querySelector('.auth-form__form-sign-up').style.display =
                        'flex';
                    aw.querySelector('.auth-form__form-sign-in').style.display =
                        'none';
                } else {
...
(() => {
    ...
    if (af) {
        af.forEach((a) => {
            const btn_link = a.querySelector(
                '.auth-form__link-to-recovery-password'
            );
            const form_signUp = a.querySelector('.auth-form__form-sign-in');
            const form_recovery = a.querySelector(
...
if (modalListCat) {
    modalListCat.forEach((mlc) => {
        ...
        const toggleLinkPos = mlc.querySelector(
            '.modal-list-catalogs__selected-position-link'
        );
        const toggleLinkCat = mlc.querySelector(
            '.modal-list-catalogs__selected-catalogs-link'
        );
        const toggleBtnPos = mlc.querySelector(
            '.modal-container__btn-position'
        );
        const toggleBtnCat = mlc.querySelector(
            '.modal-container__btn-catalogs'
        );
        const toggleBtn = mlc.querySelector(
...
try {
    ...
    if (btnLook) {
        btnLook.addEventListener('click', () => {
            document
                .querySelector('.promo-for-begginners')
